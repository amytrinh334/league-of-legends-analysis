...
| `position` | The specific role the player took during the match (Top, Jungle, Mid, ADC/Bot, or Support). Positions designateed team indicate that the data is a summary of the team statistics. |
...
| `infernals`, `mountains`, `clouds`, `oceans`, `chemtechs`, `hextechs`, `elders`| The specific breakdown of which type of dragons the team defeated. Each type grants a different permanent team-wide stat bonus. |
